...
if ($searchBy && $searchQuery) {
  ...
  if ($searchBy === 'numero') {
    ...
    if (!is_numeric($searchQuery)) {
      ...
      echo "<a href='visualizar.php'>Volver a intentar</a>";
  ...
  // Guardar el valor original antes de visualizarlo
  ...
  if ($stmt = $conexion->prepare($query)) {
    ...
    if ($result->num_rows > 0) {
      ...
      header("Location: visualizarview.php?searchBy=$searchBy&searchQuery=$searchQueryOriginal");
      exit();
    } else {
...
<body>
  <nav class="navbar">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link" href="visualizar.php" role="button" aria-expanded="false">
      visualizar
      </a>
    </li>
  ...
  <form id="searchForm" action="visualizar.php" method="GET">
